...
export const ClassificationScheme = {
	...
	DEFAULT: {
		...
		3:       { visible: true, name: 'low vegetation'    , color: [1.0,  0.714, 0.0,  1.0] },
		4:       { visible: true, name: 'medium vegetation' , color: [0.576, 0.788, 0.318, 1.0] },
		5:       { visible: true, name: 'high vegetation'   , color: [0.0,  0.6,  0.0,  1.0] },
		6:       { visible: true, name: 'building'          , color: [0.204, 0.153, 0.051, 1.0] },
